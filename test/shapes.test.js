            ...
            expect (circle. radius). toBe(50) ;
                ...
                expect (circle.renderCircle()).toBe('<svg version= "1. 1"\n width="500" height="500"\n xmlns="http://www.w3.org/2000/svg">\n <circle r="50" cx="250" cy="250" fill="#000" stroke="#fff" stroke-width="2"/>\n <text x="508" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="60px" font-weight="700" fill="#fff">Hello</text>\n </svg>');
                    ...
                    expect (polygon. renderPolygon ()).toBe('<svg version="1.1"\n width="500" height="500"\n xmlns="http://www.w3.org/2000/svg">\n <polygon points="250,60 100,400 400,400" stroke="#fff" stroke-width="2" fill="#000" />\n <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="60px" font-weight="700" fill="#fff">Hello</text>\n </svg>');
                        ...
                        const square = new Square('#000',
                        
                        '#fff', 2, 'Hello', 'efff', 400, 400); expect (square. fill). toße('#000');
                        
                        expect (square.stroke).toBe('#fff'); expect (square. strokewidth). toBe (2); expect (square. text).toBe('Hello');
                        
                        expect (square. textColor). toBe('#fff'); expect (square.width).toBe (400);
                        ...
                        expect (square. height). toBe (400) ;
                            ...
                            '<svg version="1.1"In width-"500" height="500"In xmins-"http://www.w3.org/2000/svg">In «rect width="400" height="400" fill="#008" stroke="#fff" stroke-width="2"/>\n <text x="200" y="200" dominant-baseline="middle" text-anchor="middle" font-size="60px" font-weight="700" fill="#fff">Hello</text>\n </svg>');
